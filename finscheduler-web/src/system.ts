  ...
  theme: {
    tokens: defineTokens({
      ...
      shadows: {
        ...
        glowCyan: { value: "0 0 0 1px rgba(32, 208, 255, 0.18), 0 0 24px rgba(32, 208, 255, 0.18)" },
        glowViolet: { value: "0 0 0 1px rgba(143, 120, 255, 0.22), 0 0 28px rgba(143, 120, 255, 0.18)" },
      },
      blurs: {
        soft: { value: "16px" },
        panel: { value: "20px" },
    ...
    semanticTokens: defineSemanticTokens({
      ...
      shadows: {
        card: {
          value: darkOnly("0 18px 48px rgba(3, 8, 20, 0.36), inset 0 1px 0 rgba(255, 255, 255, 0.03)"),
        },
        neon: {
          value: darkOnly("0 0 0 1px rgba(32, 208, 255, 0.18), 0 0 24px rgba(32, 208, 255, 0.18)"),
        },
        app: {
          glowCyan: {
            value: darkOnly("0 0 0 1px rgba(32, 208, 255, 0.18), 0 0 24px rgba(32, 208, 255, 0.18)"),
          ...
          glowViolet: {
            value: darkOnly("0 0 0 1px rgba(143, 120, 255, 0.22), 0 0 28px rgba(143, 120, 255, 0.18)"),
          },
          sidebarItemHover: {
            value: darkOnly("0 0 0 1px rgba(96, 165, 255, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.03)"),
          },
        },
      },
    }),
