    ...
    >
      <Flex direction="column" h="full" px={{ md: "3", lg: isCollapsed ? "3" : "4" }} py="5">
        ...
        >
          ...
          >
            <Text fontSize="2xl" fontWeight="700" color="app.accent" letterSpacing="tight">
              FinScheduler
            </Text>
          </Stack>
        </HStack>
          ...
          >
            <HStack gap="2">
              {isCollapsed
                  ...
                  : <>
                      <Text fontSize="sm" display={{ base: "none", md: "none", lg: isCollapsed ? "none" : "inline-flex" }}>Свернуть меню</Text>
